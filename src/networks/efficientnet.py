...
EfficientNetB0 = inject_keras_modules(EfficientNetB0)
EfficientNetB1 = inject_keras_modules(EfficientNetB1)
EfficientNetB2 = inject_keras_modules(EfficientNetB2)
EfficientNetB3 = inject_keras_modules(EfficientNetB3)
EfficientNetB4 = inject_keras_modules(EfficientNetB4)
EfficientNetB5 = inject_keras_modules(EfficientNetB5)
EfficientNetB6 = inject_keras_modules(EfficientNetB6)
EfficientNetB7 = inject_keras_modules(EfficientNetB7)

preprocess_input = inject_keras_modules(preprocess_input)
