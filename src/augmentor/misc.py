...
#         # if random_prob < (1 - prob):
#         #     return image, annotations
#         gt_box = annotations['bboxes']
#         gt_label = annotations['labels']
#         for i in range(100):
#             dh, dw = int(random.random() * (h - 896)), int(random.random() * (w - 896))
#             nx1 = dw
#             nx2 = dw + 896
#             ny1 = dh
#             ny2 = dh + 896
...
#             flag = len(gt_array) > 0
#             if flag:
#                 annotations['bboxes'] = gt_array
#                 annotations['labels'] = label_array
#                 break
#         if flag:
...
if __name__ == '__main__':
    ...
    for i in range(train_generator.size()):
        ...
        for box, label in zip(boxes, labels):
            ...
            cv2.putText(image, str(label), (box[0], box[1]), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 0, 255), 1)
